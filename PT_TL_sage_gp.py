    ...
    for gene_name in gene_name_ls:
        ...
        for fold, (train_ids, valid_ids) in enumerate(kfold.split(simple_dataset)):
            ...
            for l2_lambda in L2_lambda_range:
                ...
                checkpoint0 = torch.load('./Parameters/nn_checkpoints_'+gene_name+'_ukb_y1.pth')
                ...
                torch.save({
                    ...
                    }, './Parameters/nn_checkpoints_'+gene_name+'_TL_sage_'+str(lambda_idx)+'.pth')
            ...
            checkpoint = torch.load('./Parameters/nn_checkpoints_'+gene_name+'_TL_sage_'+str(l2_lambda_best_idx)+'.pth')
            DNN_best.load_state_dict(checkpoint['model_state_dict'])
            
            torch.save({
                    'model_state_dict': DNN_best.state_dict(),
                    }, './Parameters/nn_checkpoints_'+gene_name+'_TL_sage.pth')
